...
//    int remove1, remove2;
	...
	// ----------- TEST 1: choice1 = 1 = -1 card to supply all other players get +1 of same card --------------
	printf("TEST 1: choice1 = 1 = -1 card to supply all other players get +1 of same card\n");
    ...
    newCards = 1; // other player gains discarded card form Supply
...
// Need code to check other players hand totals to ensure no change in state
	...
	// ----------- TEST 2: choice1 = 2 = -2 card to supply all other players get +1 of same card --------------
	printf("TEST 2: choice1 = 2 = -2 card to supply all other players get +1 of same card\n");
...
// Need code to check other players hand totals to ensure no change in state
    ...
    discarded = 0; // setting for Other Player
    newCards = xtraCoins = shuffledCards = numBuys = 0;
    newCards = 1; // Other player gains 1 cards from Supply
