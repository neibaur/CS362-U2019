...
//    int remove1, remove2;
    ...
    testG.handCount[thisPlayer] = randInt(0,10);
    ...
    testG.handCount[otherPlayer] = randInt(0,10); // tried to cover all lines with gcov, but this didn't fully work
...
//	printf("TEST 2: choice1 = 2 = Discard hand +4 cards and ALL other players with 5 cards \ndiscard and draw 4 cards and +1 Action\n");
//
//	// copy the game state to a test case
//	memcpy(&testG, &G, sizeof(struct gameState));
//	choice1 = 2;
