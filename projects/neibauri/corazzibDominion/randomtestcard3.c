...
//    int remove1, remove2;
    ...
    numActions = randInt(0,2);
    discarded = randInt(0,2);
    xtraCoins = randInt(0,2);
    ...
    discarded = randInt(0,2); // tribute action on other player
    ...
    testG.handCount[otherPlayer] = randInt(0,10);
